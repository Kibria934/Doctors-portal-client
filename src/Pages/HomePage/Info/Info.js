...
const Info = () => {
    return (
        <div className='grid grid-cols-1 mb-20 sm:w-100 md:grid-cols-2 lg:grid-cols-3 gap-10 m-6'>
            ...
            <InfoCard cardInfo='Brooklyn, NY 10036, United States' cardTitle='Visit our location' bg={"bg-accent"} img={marker}></InfoCard>
            <InfoCard cardInfo='+000 123 456789' cardTitle='Contact us now' bg={"bg-gradient-to-r from-primary to-[#19D3AE]"} img={phone}></InfoCard>
        </div>
    );
};
